...
export const offers: Record<OfferLocale, Record<OfferId, OfferCopy>> = {
  de: {
    ...
    geo_support: {
      ...
      duration: "Zunächst drei Monate, danach monatlich.",
      scope: "Ein definierter monatlicher Prioritätsblock und ein festes Messpanel. SEO-, Content- und GEO-Maßnahmen werden nach aktueller Priorität ausgewählt sowie innerhalb der vereinbarten Kapazität umgesetzt und geprüft.",
  ...
  en: {
    ...
    geo_support: {
      ...
      duration: "Three months to begin with, monthly thereafter.",
      scope: "One defined monthly priority block and a fixed measurement panel. SEO, content and GEO measures are selected by current priority, then implemented and reviewed within the agreed capacity.",
