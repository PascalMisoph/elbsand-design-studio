...
export const geoAuditPages: Record<ServiceLocale, ServicePageContent> = {
  ...
  en: {
    ...
    lead: "Competitors appear in buyer answers but your business rarely does? We investigate answers, sources and your key pages. You receive a documented diagnosis and prioritised actions in a one-off paid audit.",
    ...
    faq: {
      ...
      items: [
        ...
        { question: "How many questions are examined?", answer: "The starting scope is 20 jointly confirmed buyer questions, three available search surfaces and three repetitions per question. Actual platform access and scope are agreed before work begins. Failed observations are documented, not counted as missing visibility." },
