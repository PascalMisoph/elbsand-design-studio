...
|---|---|---|
| 2026-09-08 | Homepage-Onpage-Befunde des Seobility-Reports bereinigt: HTML-Charset im Response ergänzt, Titel an H1 und Suchintention ausgerichtet, leere `strong`-/`b`-Tags entfernt und Alttexte für die Homepage-Bilder vervollständigt; DE/EN global geprüft. | `npm run verify` mit 146/146 Browser-Tests; Live-Crawl mit 42/42 erfolgreichen Routen am 08.09.2026. Backlinks und Social-Signale bleiben externe Maßnahmen und werden nicht künstlich erzeugt. |
