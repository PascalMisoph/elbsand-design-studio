...
- Revenue Sprint 1 implementation, attribution boundaries, regression tests and release evidence: `docs/revenue-sprint-1-2026-09-06.md`. Audit and page sprint are direct inquiry offers; public prices stay inquiry-only, research and Dresden remain separate later work.
